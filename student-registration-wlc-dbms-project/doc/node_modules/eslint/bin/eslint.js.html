...
<html>
<head>
  <title>eslint.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../../doc-style.css" />
  <script src="../../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/eslint/bin/eslint.js";
...
<p>start the MCP server if <code>--mcp</code> is present</p>

        </td>
        <td class="code highlight">
          <pre class="javascript">	<span class="hljs-keyword">if</span> (process.argv.includes(<span class="hljs-string">"--mcp"</span>)) {
		<span class="hljs-built_in">console</span>.warn(
			<span class="hljs-string">"You can also run this command directly using 'npx @eslint/mcp@latest'."</span>,
		);

		<span class="hljs-keyword">const</span> spawn = <span class="hljs-built_in">require</span>(<span class="hljs-string">"cross-spawn"</span>);

		spawn.sync(<span class="hljs-string">"npx"</span>, [<span class="hljs-string">"@eslint/mcp@latest"</span>], {
			<span class="hljs-attr">encoding</span>: <span class="hljs-string">"utf8"</span>,
			<span class="hljs-attr">stdio</span>: <span class="hljs-string">"inherit"</span>,
		});
		<span class="hljs-keyword">return</span>;
