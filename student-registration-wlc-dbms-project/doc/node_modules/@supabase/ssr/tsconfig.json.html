...
<head>
  ...
  <script>
    var relativeDir = "../../../";
    var thisFile = "node_modules/@supabase/ssr/tsconfig.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <span class="hljs-attr">"compilerOptions"</span>: {
    <span class="hljs-comment">/* Base Options: */</span>
    ...
    <span class="hljs-comment">/* Strictness */</span>
    <span class="hljs-attr">"strict"</span>: <span class="hljs-literal">true</span>,
    <span class="hljs-attr">"noImplicitOverride"</span>: <span class="hljs-literal">true</span>,
    <span class="hljs-attr">"module"</span>: <span class="hljs-string">"preserve"</span>,
    <span class="hljs-attr">"outDir"</span>: <span class="hljs-string">"dist/module"</span>,
    <span class="hljs-attr">"sourceMap"</span>: <span class="hljs-literal">true</span>,
    <span class="hljs-comment">/* AND if you're building for a library: */</span>
    <span class="hljs-attr">"declaration"</span>: <span class="hljs-literal">true</span>,
    <span class="hljs-comment">/* If your code runs in the DOM: */</span>
